...
int main(void)
{
        ...
        xTaskCreate( LEDGreenTask, "LEDTask 2", configMINIMAL_STACK_SIZE, NULL,3, NULL );
        xTaskCreate( LEDBlueTask,   "LEDTask 3", configMINIMAL_STACK_SIZE, NULL, 2, NULL );
...
static void LEDGreenTask(void *pvParameters)
{
    ...
    vTaskDelay(100);
    if(switchState(1) == RELEASED) ledControl(LEDGREEN,OFF);
    vTaskDelay(100);
    }
}
